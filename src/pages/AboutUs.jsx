...
const AboutUs = () => {
  return (
    <div>
      ...
      {/* Hero Section */}
      <div className='w-full mt-[36px] flex relative flex-col md:flex-row items-center justify-center gap-10 bg-blue-300 px-6 py-10'>
      ...
      {/* About Section */}
      <div className='w-full mt-5 md:mt-20 flex flex-col md:flex-row items-center justify-center gap-10 bg-[#eaf4f9] px-6 py-20'>
