        ...
        <div className="w-full flex justify-center items-center mt-10 mb-10">
            ...
            >
                ...
                <div className="relative z-10 gap-3 text-center text-white flex flex-col items-center justify-center h-full">
                    <h1 className="text-4xl md:text-5xl font-bold">Need Custom <span className='text-[#FF6900]'>Manpower</span> Solutions?</h1>
                    <p className="text-md mt-2">We offer tailored services to meet your specific requirements.</p>
                    <button className="mt-4 px-6 py-3 bg-white text-[#176ABC] font-semibold rounded-full shadow-md hover:bg-gray-200 transition-all cursor-pointer">
                        Request a Quote
                    </button>
                </div>
            </div>
