        ...
        <div className="w-full mt-14 max-w-6xl mx-auto flex flex-col md:flex-row flex-wrap justify-between gap-5">
          ...
          <div className="w-full md:w-1/4 space-y-3">
            ...
            <div className="flex gap-3">
              <FaFacebook className="text-[#176ABC] text-2xl cursor-pointer hover:scale-110 transition" />
              <FaLinkedin className="text-[#176ABC] text-2xl cursor-pointer hover:scale-110 transition" />
              <FaSquareTwitter className="text-[#176ABC] text-2xl cursor-pointer hover:scale-110 transition" />
              <FaInstagramSquare className="text-[#176ABC] text-2xl cursor-pointer hover:scale-110 transition" />
            </div>
          </div>
          ...
          <div className="w-full md:w-1/4 space-y-3">
            ...
            <p className="text-gray-300 text-lg flex items-center gap-3">
              <FaLocationDot className="text-[#176ABC]" /> 123 Business Street, Suite 100, New York, NY 10001
            </p>
            <p className="text-gray-300 text-lg flex items-center gap-3">
              <FaPhoneAlt className="text-[#176ABC]" /> +1 (234) 567-890
            </p>
            <p className="text-gray-300 text-lg flex items-center gap-3">
              <IoMail className="text-[#176ABC]" /> info@manpower.com
            </p>
          </div>
        </div>
