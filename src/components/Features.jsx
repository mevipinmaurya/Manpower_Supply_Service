    ...
    return (
        <div className="w-full flex flex-col items-center justify-center mt-10 px-6">
            ...
            <div className="w-full max-w-3xl text-center mb-12">
                <h1 className="text-4xl font-bold text-[#2161F5]">Features & Benefits</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl w-full">
                {features.map((feature, index) => (
                    ...
                    >
                        ...
                        <div className="absolute top-0 left-0 w-full h-1 bg-[#2161F5] rounded-t-xl"></div>

                        {/* Image Wrapper */}
                        <div className="flex items-center justify-center w-14 h-14 bg-[#2161F5] rounded-full shadow-lg mx-auto">
                        ...
                        {/* CTA Button */}
                        <button className="mt-5 px-5 py-2 bg-[#2161F5] text-white text-sm font-semibold rounded-full shadow-md transition-all duration-300 ease-in-out hover:bg-[#2161F5] cursor-pointer mx-auto">
                            Learn More
                        </button>
                    </div>
                ))}
