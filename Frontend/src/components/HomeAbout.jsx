            ...
            <div className=' w-full max-w-6xl flex flex-col md:flex-row items-center justify-center gap-10 px-6 py-20'>
                <div className='w-full max-w-6xl flex flex-col md:flex-row items-center'>
                    <div className='md:w-1/2 flex flex-col items-center md:items-start text-center md:text-left'>
                        <h2 className='font-bold text-3xl sm:text-4xl md:text-5xl text-[#2161F5]'>About Us</h2>
                        ...
                        <Link to={'/about'}>
                            <button className='bg-[#2161F5] mt-6 w-[200px] hover:bg-[#2161F5] cursor-pointer p-3 rounded-xl text-white font-bold'>Read More</button>
                        </Link>
                    </div>
