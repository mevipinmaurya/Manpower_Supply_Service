    ...
    <div className='w-full px-4'>
      <div className='max-w-[1200px] mx-auto flex flex-col gap-4 mt-5'>
        ...
        <div className='w-full flex flex-col md:flex-row gap-5'>
          ...
          {/* Categories - Right on desktop, Top on mobile */}
            ...
            <div className='w-full'>
              ...
              <ul className='flex flex-row md:flex-col flex-wrap gap-4 text-gray-500'>
                {categories.map((category) => (
                  <li
                    key={category}
                    className={`w-fit cursor-pointer hover:border-b-[1px] hover:text-gray-900 font-medium ${
                      selectedTag === category ? 'text-black font-semibold border-b-[1px]' : ''
                    }`}
          ...
          {/* Blog Posts - Left on desktop, Bottom on mobile */}
                ...
                >
                  <div className='w-full flex flex-col md:flex-row'>
                    ...
                    <div className='md:w-2/3 p-3 flex flex-col'>
                      ...
                      <Link className='text-[#2161F5] w-fit border-b-[1px] text-bold text-xl cursor-pointer mt-2'>
                        read more
                      </Link>
                    </div>
                  </div>
